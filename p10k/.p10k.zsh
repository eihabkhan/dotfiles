# Generated by Powerlevel10k configuration wizard on 2025-11-05 at 22:18 +01.
...
() {
  ...
  function my_git_formatter() {
    ...
    local       meta='%244F'  # medium gray
    local      clean='%250F'  # light gray (branch name)
    local   modified='%246F'  # medium gray
    local  untracked='%244F'  # darker gray
    local conflicted='%240F'  # dark gray
...
# ========================================
# MINIMAL DARK GRAYSCALE THEME (232-255)
# ========================================
# Replace the Vesper section at the bottom of your .p10k.zsh with this

# Directory - lightest gray on dark gray
# Rosé Pine Moon color scheme
# Base colors: bg=#232136, fg=#e0def4, muted=#6e6a86, subtle=#908caa
# Highlight colors: love=#eb6f92, gold=#f6c177, rose=#ea9a97, pine=#3e8fb0, foam=#9ccfd8, iris=#c4a7e7

typeset -g POWERLEVEL9K_DIR_FOREGROUND=189        # e0def4 (text)
typeset -g POWERLEVEL9K_DIR_BACKGROUND=235        # 232136 (base)
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=146  # 908caa (subtle)
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=183     # c4a7e7 (iris)

# Git Status - Rosé Pine Moon
typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=152      # 9ccfd8 (foam - clean)
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=235      # 232136 (base)
typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=222   # f6c177 (gold - modified)
typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=235
typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=174  # ea9a97 (rose - untracked)
typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=235
typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=210 # eb6f92 (love - conflict)
typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=235

# Status - minimal contrast
typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=152      # 9ccfd8 (foam)
typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=234
typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=210   # eb6f92 (love)
typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=234

# Command execution time
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=146  # 908caa (subtle)
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=234

# Time
typeset -g POWERLEVEL9K_TIME_FOREGROUND=242       # 6e6a86 (muted)
typeset -g POWERLEVEL9K_TIME_BACKGROUND=233

# Context (user@host)
typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=189    # e0def4 (text)
typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=235    # 232136 (base)

# Background jobs
typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=183  # c4a7e7 (iris)
typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=234

# OS Icon
typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=73     # 3e8fb0 (pine)
typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=235

# Prompt character (if using two-line)
typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=152  # foam
typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=210  # love
...
# Optional: Transient prompt (keeps terminal clean)
typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=always